...
{
 if (chayma_edit==0){
GtkWidget *inpute1, *inpute2, *inpute3, *inpute4, *inpute5,*inpute6,*msg; 
...
void
on_chayma_button_mdf_conf_clicked      (GtkButton       *widget,
                                        gpointer         user_data)
{
/*chayma_focus_affichage = 0;
GtkWidget *inpute1, *inpute2, *inpute3, *inpute4, *inpute5,*inpute6,*msg; 
...
int flag=0;
if (chayma_sup_oui_non)
{flag=modifier_rec(rec,Numlist);
msg=lookup_widget(widget,"label297");
gtk_label_set_text(msg,"Modification ajouter avec succee!");
}*/
...
void
on_chayma_entry_ls_numlist_changed     (GtkEditable     *editable,
                                        gpointer         user_data)
{
GtkWidget *entry;
char numliste[20]="", fich[20]="reclamation.txt";
int i;
GtkWidget *tree;
tree=lookup_widget(editable,"chayma_treeview_ls");
entry=lookup_widget(GTK_WIDGET(editable),"chayma_entry_ls_numlist");
i=atoi(gtk_entry_get_text(GTK_LABEL(entry)));
sprintf(numliste,"%d",i);
chercher_rec(tree,numliste);
}
...
GtkWidget *msg;
msg = lookup_widget(button,"label297");
...
on_chayma_button_stat_rec_clicked      (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *chayma_window_stat;
GtkWidget *chayma_window_aff;
chayma_window_aff=lookup_widget(button,"Liste_reclamation");
gtk_widget_destroy(chayma_window_aff);
chayma_window_stat=lookup_widget(button,"window_chayma_stat_nb_rec");
chayma_window_stat=create_window_chayma_stat_nb_rec();
gtk_widget_show(chayma_window_stat);
}
...
gtk_widget_destroy(chayma_window_aff);
chayma_window_stat=lookup_widget(button,"window_chayma_stat_nb_rec");
chayma_window_stat=create_window_chayma_stat_gagnant();
gtk_widget_show(chayma_window_stat);
}
...
gboolean
on_window_chayma_stat_nb_rec_focus_in_event
                                        (GtkWidget       *widget,
                                        GdkEventFocus   *event,
                                        gpointer         user_data)
{
...
void
on_chayma_entry_stat_rec_changed       (GtkEditable     *editable,
                                        gpointer         user_data)
{
GtkWidget *entry;
char numliste[20]="", fich[20]="reclamation.txt";
int i;
GtkWidget *tree;
tree=lookup_widget(editable,"chayma_treeview_stat_rec");
entry=lookup_widget(GTK_WIDGET(editable),"chayma_entry_stat_rec");
i=atoi(gtk_entry_get_text(GTK_LABEL(entry)));
sprintf(numliste,"%d",i);
chercher_rec(tree,numliste);
}
...
void
on_chayma_treeview_stat_rec_row_activated
...
gtk_tree_model_get(GTK_LIST_STORE(model),&iter, NUMLIST, &numlist ,-1);
strcpy(Numlist,numlist); 
chayma_edit_stat_rec = 0;
}
}


void
on_chayma_aff_stat_nb_rec_clicked      (GtkButton       *button,
                                        gpointer         user_data)
{
char nb[20];
int x=-1;
GtkWidget *chayma_treeview_aff;
GtkWidget *chayma_window_aff, *chayma_label_aff_nb;
chayma_label_aff_nb=lookup_widget(GTK_WIDGET(button),"chayma_label_aff_nb");
chayma_window_aff=lookup_widget(button,"window_chayma_stat_nb_rec");
//gtk_widget_destroy(chayma_window_aff);
//chayma_window_aff=lookup_widget(button,"window_chayma_stat_nb_rec");
//chayma_window_aff=create_window_chayma_stat_nb_rec();
//gtk_widget_show(chayma_window_aff);
x=nbrtot("reclamation.txt");
sprintf(nb,"%d",x);
gtk_label_set_text(GTK_LABEL(chayma_label_aff_nb),nb);

chayma_treeview_aff=lookup_widget(chayma_window_aff,"chayma_treeview_stat_rec");
afficher_stat_rec(chayma_treeview_aff,"reclamation.txt");
}


gboolean
on_window_chayma_stat_gagnant_focus_in_event
                                        (GtkWidget       *widget,
                                        GdkEventFocus   *event,
                                        gpointer         user_data)
{
...
void
on_chayma_treeview_stat_gag_row_activated
                                        (GtkTreeView     *treeview,
                                        GtkTreePath     *path,
                                        GtkTreeViewColumn *column,
                                        gpointer         user_data)
...
void
on_chayma_button_aff_stat_gag_clicked  (GtkButton       *button,
                                        gpointer         user_data)
{
...
void
on_chayma_button_stat_ret_nb_gag_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *chayma_window_stat;
GtkWidget *chayma_window_aff;
chayma_window_stat=lookup_widget(button,"window_chayma_stat_gagnant");
gtk_widget_destroy(chayma_window_stat);
chayma_window_aff=lookup_widget(button,"Liste_reclamation");
chayma_window_aff=create_Liste_reclamation();
gtk_widget_show(chayma_window_aff);
}
...
void
on_chayma_button_stat_ret_rec_clicked  (GtkButton       *button,
                                        gpointer         user_data)
